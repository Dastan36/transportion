...
<body>
<br>
<div class="layui-layout" style="width: 1285px;">
    <div style="width: 670px;">
        <form class="layui-form stationForm">
            <div class="layui-form-item" >
                <label class="layui-form-label">站点：</label>
                <div class="layui-input-inline">
                    <input id="stationName" type="text" name="stationName" placeholder="请输入" lay-verify="required"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="coordinate_l" placeholder="请输入" lay-verify="required"
                           autocomplete="off" class="layui-input coordinate_l">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="coordinate_r" placeholder="请输入" lay-verify="required"
                           autocomplete="off" class="layui-input coordinate_r">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="city" placeholder="请输入"   autocomplete="off" lay-verify="required"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="province" placeholder="请输入" lay-verify="required"
            ...
            <div class="layui-form-item">
                <div class="layui-input-block" hidden>
                    <button class="layui-btn createBtn" lay-submit lay-filter="btn_save" >添加</button>
                </div>
            </div>
        </form>
...
<script>
    ...
    /* layui.use(['form'], function () {
       ...
       form.render();
        ...
        form.on('select(btn_save)', function() {
            alert(2);
        });
    })*/
