    ...
    <div id="content" style="margin: 0 125px 0 125px;padding: 40px;background-color: #ffffff;">
        ...
        <form class="layui-form complaintForm" >
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="complaintName" placeholder="请输入投诉人姓名" autocomplete="off"  lay-verify="required" lay-verType="msg"
                           class="layui-input">
                </div>
                <label class="layui-form-label">投诉人电话</label>
                <div class="layui-input-inline">
                    <input type="text" name="complaintPhone" placeholder="请输入投诉人电话"  lay-verify="phone" lay-verType="msg"
