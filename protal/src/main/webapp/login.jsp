...
<head>
    ...
    <style type="text/css">
        ...
        .rgba {
            background-color: rgba(0, 0, 0, 0.3); /* 为文字更好显示，将背景颜色加深 */
            position: absolute; /* 固定半透明色层位置 */
            width: 100%;
            height: 80%;
            z-index: -1; /* 中间是rgba半透明色层 */
...
<div class="bg">
    <article class="blur_box">
        ...
        <div class="divForm" style="width: auto">
            <h2 style="color: #eae4d7">铁路货运欢迎你</h2>
            <br>
            <form class="layui-form" action="userlogin">
                <div class="layui-form-item">
                    <label class="layui-form-label" style="color: #eae4d7">手机号</label>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label" style="color: #eae4d7">密&nbsp;&nbsp;码</label>
                    <div class="layui-input-inline">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label" style="color: #eae4d7">滑动验证</label>
                ...
                <div align="center" class="layui-form-item">
                    <div class="layui-input-block">
                        ...
                        <button id="registerBtn" class="layui-btn layui-btn-normal" type="button">注册</button>
                    </div>
                </div>
            </form>
        </div>
